...
/**
 * @brief Afficher et mettre en forme le header d'un fichier FITS - PRIM 30 & PRIM 10
 *
...
// void lire_donnees_image(char *chemin_fichier, struct header *entete)
// {
...
//     entete->DATA = (int **)malloc(sizeof(int *) * entete->NAXIS2);
//     if (entete->DATA == NULL)
//     {
...
//     for (int i = 0; i < entete->NAXIS2; i++)
//     {
//         entete->DATA[i] = (int *)malloc(sizeof(int) * entete->NAXIS1);
//         if (entete->DATA[i] == NULL)
//         {
//             perror("Erreur d'allocation de mémoire");
//             fclose(fichier);
//             exit(EXIT_FAILURE);
...
//     for (int i = 0; i < entete->NAXIS2; i++)
//     {
//         for (int j = 0; j < entete->NAXIS1; j++)
//         {
//             if (fread(&pixel, sizeof(pixel), 1, fichier) == 1)
//             {
//                 pixel = (pixel >> 8) | (pixel << 8);
//                 entete->DATA[i][j] = pixel;
//             }
//         }
//     }
...
//  * @param entete
//  */
// void ecrire_donnees_csv(char *chemin_fichier_csv, struct header *entete)
// {
...
//         for (int j = 0; j < entete->NAXIS1; j++)
//         {
//             double valeur_reelle = entete->BZERO + entete->BSCALE * entete->DATA[i][j];
//             fprintf(fichier_csv, "%f", valeur_reelle);
//             if (j < entete->NAXIS1 - 1)
//             {
//                 fprintf(fichier_csv, ";");
//             }
//         }
